...
sys.path.insert(0, os.path.abspath('../../coastal')) # the code
sys.path.insert(0, os.path.abspath('../../examples')) # the example notebooks
...
html_context = {
    ...
    "github_repo": "ICESAT-2HackWeek/coastal_topobathy", # Repo name
